...
# clear, start, and stop pushbuttons
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports clear]
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports start]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports stop]
